...
/**
 * Created by lad on 23/03/2016.
 */
public class Setting_DNS {
...
//            Log.d("Setting_DNS", "setIpAssignment (line 24): 123123"+ipConfiguration.toString());
        } else {
            setEnumField(wifiConf, assign, "ipAssignment");
        }
    }
    ...
    public static void setDNS(InetAddress dns1,InetAddress dns2, WifiConfiguration wifiConf)
        ...
        mDnses.add(dns1);
        mDnses.add(dns2);
        Log.d("Setting_DNS", "setDNS (line 67): 0031 "+mDnses.toString());
    }
